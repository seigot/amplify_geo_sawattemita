...
import CustomIcon from './adachi_sumi.png';
...
//			    draw(sourcename, lati, longi, iconi);
    ...
    return (
	<div className="App_adachi">
	    <h1>OshitaKan Stamp Map (adachi)</h1>
	    <ul id="locations">
		<li><b>Moriguchi, Osaka prefecture, moriguchi-shi kawara-cho [135.5617,34.7357] </b></li>
